    ...
    public class MvaUsersController : Controller
    {
        ...
        public IActionResult Excel(string ApplicationName = null, int RoleID = 0, string fullName = null, int employeeNo = 0)
        {
            ...
            using (var workbook = new XLWorkbook())
            {
                ...
                var currentRow = 1;
                Color color = ColorTranslator.FromHtml("#B68A35"); 
                Color color2 = ColorTranslator.FromHtml("#FFFDF2"); 
                ...
                worksheet.Cell(currentRow, 4).Value = "AccessLevel";
                worksheet.Cell(currentRow, 5).Value = "Remarks";
                worksheet.Cell(currentRow, 6).Value = "Date";
                worksheet.Cell(currentRow, 7).Value = "Test1";
                worksheet.Cell(currentRow, 8).Value = "Test2";
                worksheet.Cell(currentRow, 9).Value = "Test3";
                worksheet.Cells("A1:I1").Style.Fill.SetBackgroundColor(xlColor);
              ...
              dd.Style.Alignment.Horizontal = (XLAlignmentHorizontalValues)ExcelHorizontalAlignment.General;
                ...
                {
                    currentRow++;
                    worksheet.Cell(currentRow, 1).Value = item.LoginName;
                    worksheet.Cell(currentRow, 2).Value = item.FullName;
                    worksheet.Cell(currentRow, 3).Value = item.ApplicationName;
                    worksheet.Cell(currentRow, 4).Value = item.AccessLevel;
                    worksheet.Cell(currentRow, 5).Value = item.Remarks;
                    worksheet.Cell(currentRow, 6).Value = item.CreationDate;
